...
export default function FixedMaterialListPage() {
    return (
        <SidebarProvider>
                ...
                <div className="flex-1 flex flex-col h-screen overflow-hidden">
                    ...
                    <main className="flex-1 overflow-y-auto px-8 py-8 custom-scrollbar">
                        <div className="max-w-7xl mx-auto space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h2 className="text-2xl font-black text-slate-800 tracking-tight">Material Inventory</h2>
                                    </div>
                                    <p className="text-slate-500 font-medium max-w-2xl">
                                        Comprehensive registry of all fixed assets held within the institution.
                                        This view is strictly for monitoring and tracking purposes.
                                    </p>
                                </div>
                                <div className="flex items-center gap-6 relative z-10 border-l border-slate-100 pl-8">
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs font-bold text-indigo-600 flex items-center gap-2 justify-end">
                            ...
                            {/* Main List Component */}
                            <MaterialList typeFilter="fixed_asset" />
                        </div>
                    </main>
                </div>
            </div>
