...
export default function ReceiveGoodsPage() {
    ...
    const handleApprove = async (transferId: string) => {
        ...
        try {
            ...
            // 3. Mark the transfer as completed directly
            ...
            setHistoryTransfers(prev => [{ ...transfer, status: 'completed', updatedAt: { seconds: Date.now() / 1000 } }, ...prev]);
        } catch (error) {
    ...
    const handleReject = async (transferId: string) => {
        ...
        try {
            ...
            if (transfer) {
                ...
                // Set materials back to 'accepted' status for the sender
                for (const material of transfer.materials) {
                    if (material.userReportId) {
                        const userReportRef = doc(db, 'User-Report', material.userReportId);
                        await updateDoc(userReportRef, {
