...
import {
    collection, query, where, getDocs, addDoc, serverTimestamp, orderBy, doc, getDoc, onSnapshot, updateDoc
...
export default function ReturnGoodsPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Update materials status in User-Report to 'transferring'
            for (const mat of selectedMaterials) {
                const matRef = doc(db!, 'User-Report', mat.id);
