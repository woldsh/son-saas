                    ...
                    <div className="px-6 pt-9 pb-7">
                        <div className="flex items-center gap-3.5">
                            <div className="relative">
                                <div className="absolute inset-0 bg-purple-500/10 blur-xl rounded-full translate-y-1"></div>
                                <div className="relative w-[52px] h-[52px] rounded-[14px] bg-white shadow-[0_4px_12px_-2px_rgba(0,0,0,0.06)] flex items-center justify-center border border-gray-50/50">
                                    <GraduationCap size={22} className="text-purple-600" strokeWidth={2.5} />
                                </div>
                            </div>
                            <div className="flex flex-col min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 mt-1.5">
                                    ...
                                    <p className="text-[9px] font-black text-purple-400 uppercase tracking-[0.15em]">
                                        STUDENT SERVICES
                                    </p>
                                </div>
                            </div>
                                    ...
                                    {isDropdown ? (
                                        <div className="space-y-0.5">
                                            ...
                                            >
                                                ...
                                                {item.badge > 0 && (
                                                    <span className="flex items-center justify-center min-w-[20px] h-5 px-1.5 bg-purple-600 text-white text-[10px] font-black rounded-full">
                                                        {item.badge}
                                                    </span>
                                                )}
                                                {isDropdownOpen ? (
                                                                ...
                                                                return (
                                                                    <Link
                                                                        ...
                                                                        className={`flex items-center gap-3.5 px-6 py-3 rounded-[12px] transition-all duration-200 ${isSubActive
                                                                            ? 'bg-purple-50/40 text-purple-700 font-medium'
                                                                            : 'text-slate-500 hover:bg-gray-100/40 hover:text-slate-800'
                                                                            }`}
                                                                    >
                                                                        <SubIcon size={18} strokeWidth={1.5} className={isSubActive ? 'text-purple-600' : 'text-slate-400'} />
